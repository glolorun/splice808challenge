...
} from 'tone/build/esm/core/context/ToneWithContext';
...
export function getLog(value: any) {
  console.log(value);
}
...
export function startLoop() {
  const loop = new Tone.Loop((time) => {
    ...
    console.log('NewLoop at ' + time);
  }, '16').start(0);
  Tone.Transport.scheduleRepeat(function (time) {
    console.log('Note ' + Tone.Transport.getTicksAtTime(time) / 48);
  }, '16n'),
